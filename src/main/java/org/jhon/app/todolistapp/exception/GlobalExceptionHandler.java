...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ApiError> handleHttpMessageNotReadableException(HttpMessageNotReadableException httpMessageNotReadableException,
        ...
        ApiError apiError = new ApiError(
                ...
                request.getMethod(),
                "Ooops! Error reading the HTTP message body. Make sure the request is correctly formatted and contains valid data.",
    ...
    private ResponseEntity<ApiError> handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException httpMediaTypeNotSupportedException,
        ...
        ApiError apiError = new ApiError(
                ...
                "Unsupported Media Type: The server is unable to process the requested entity in the format provided in the request." +
                        "Supported media types are: " + httpMediaTypeNotSupportedException.getSupportedMediaTypes() +"and you sent: " + httpMediaTypeNotSupportedException.getContentType(),
    ...
    private ResponseEntity<ApiError> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException httpRequestMethodNotSupportedException,
        ...
        ApiError apiError = new ApiError(
                ...
                request.getRequestURL().toString(),
                request.getMethod(),
                "Oops! Method not allowed. check the HTTP method of you request.",
    ...
    private ResponseEntity<ApiError> handleMethodArgumentNotValidException(MethodArgumentNotValidException methodArgumentNotValidException,
        ...
        ApiError apiError = new ApiError(
                ...
                request.getRequestURL().toString(),
                request.getMethod(),
                "The request contains invalid op incomplete parameters. Please verify and provide the required information before trying again",
