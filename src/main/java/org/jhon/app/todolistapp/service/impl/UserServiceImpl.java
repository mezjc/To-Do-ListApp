...
public class UserServiceImpl implements UserService {
    ...
    public GetUser findOneByFirstname(String name) {
        return UserMapper.toGetDto(this.findOneEntityByFirstname(name));
    }

    @Transactional(readOnly = true)
    public User findOneEntityByFirstname(String name) {
    ...
    @Override
    public GetUser UpdateOneByUsername(String firstname, SaveUser saveDto) {
